...
if ($db->num_rows($sql_get_list_post))
{
    ...
    if ($current_page > 1 && $total_page > 1){
        echo '<a class="btn btn-default" href="' . $_DOMAIN . 'posts&page=' . ($current_page - 1) . '"><span class="fa fa-chevron-left"></span> Prev</a>';
    }
    ...
    if ($current_page < $total_page && $total_page > 1){
        echo '<a class="btn btn-default" href="' . $_DOMAIN . 'posts&page=' . ($current_page + 1) . '">Next <span class="fa fa-chevron-right"></span></a>';
    }
    echo '<br><br><br></div>';
