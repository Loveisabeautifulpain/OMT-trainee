...
.menu-expand-list:first-of-type{
    padding-left:0px;
    margin-left:0px;
}
.sub-menu-expand-list .sub-menu-expand-item.cate {
    border-bottom: 1px solid #acacac;
    margin-bottom: 24px;
    position: relative;
}
.menu-expand-item .sub-menu-expand-list .sub-menu-expand-item a:hover{
    color:red;
    text-decoration: none;
}
...
.news-top-right .newsbox .thumb{
    width: 140px;
}
.news-top-right .newsbox a{
    margin-right:10px;
}
